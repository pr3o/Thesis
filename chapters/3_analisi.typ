...
== Macro-requisiti
Le _user stories_ raccolte si lasciano ricondurre a tre direttrici funzionali, che sintetizzano l'intero impianto e fanno da bussola alla lista di dettaglio. La prima è la *comprensione del contesto operativo*: l'assistente deve estrarre entità specifiche - operatori, commesse, date, tipologie di task - da richieste destrutturate in lingua italiana, eventualmente arricchite da allegati. La seconda è il *supporto decisionale non distruttivo*: il sistema formula piani di lavoro anche complessi senza alcuna autorità di alterare direttamente lo stato del database di produzione, demandando ogni scrittura a un'esplicita approvazione dell'operatore. La terza è la *trasparenza del flusso logico*: l'operatore deve poter visionare il ragionamento del modello e gli strumenti che ha consultato, così da poterne verificare e validare le proposte.

== Quadro dei requisiti
L'analisi ha prodotto *trenta requisiti funzionali*, *sette requisiti qualitativi* e *quattro vincoli*. I requisiti funzionali coprono l'intero ciclo d'uso: la gestione del contesto (allegati e conversazioni come fonte), l'interrogazione informativa sui dati del gestionale, la generazione di proposte di pianificazione e il loro affinamento iterativo, l'anteprima e l'applicazione selettiva delle operazioni, la creazione guidata di appuntamenti, la riorganizzazione delle agende a fronte di imprevisti e la gestione della conversazione. I requisiti qualitativi fissano le proprietà trasversali - coerenza delle risposte con il contesto, chiarezza delle notifiche, consistenza tra gestionale e database, integrazione visiva con Agilis, tempi di risposta ragionevoli e tracciabilità delle elaborazioni. I vincoli, infine, recepiscono le condizioni imposte dal contesto aziendale: sviluppo su framework .NET compatibile con Agilis, integrazione con Symposium, divieto di modifiche autonome alla pianificazione e architettura modulare.\

La @tab:riepilogo-requisiti ne riassume la distribuzione per tipologia e necessità; il tracciamento puntuale di ciascun requisito verso la _user story_ o la fonte di origine è in #link(<cap:A-appendice>)[Appendice A].
