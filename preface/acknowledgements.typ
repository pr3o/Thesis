...
Infine, desidero ringraziare i colleghi di #myCompany. e il mio tutor aziendale, #myTutor, per l'opportunità di lavorare a questo progetto. Un ringraziamento particolare va al loro supporto, sia tecnico che umano, ricevuto durante le settimane di tirocinio; la loro vicinanza è stata fondamentale per superare le difficoltà personali che hanno caratterizzato questo periodo.
]
#v(2em)
